...
- Built the discipline itself to prepare for future hires: a weekly design review, biweekly refinements, onboarding documentation, and process, principles, and task-management documentation for the practice.
...
Product strategy and discipline-building detail (added 2026-07-23, verified by Manel): with no PM at Remuner, involved in product strategy, definition, and evolution from the design side throughout, beyond the AI agent's capability scoping already noted above. The discipline-building bullet above (design review, refinements, onboarding and practice documentation) was built anticipating future designers joining, not for personal use; frame as institutional infrastructure, not a personal working system.
...
Discipline/process pushes (added 2026-07-23, verified by Manel): proactively proposed process and quality-bar improvements for the discipline at Abacum, not just the product. These were run through and carried by the head of design, not solely owned by Manel. Attribute as proposed to / co-led with the head of design, never as sole ownership.

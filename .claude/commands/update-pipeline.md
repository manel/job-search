...
argument-hint: [company] [status: in-progress|applied|interviewing|offer|rejected|stale|deferred|skipped]
...
- "applied": set the Next action column using the follow-up policy in applications.md (nudge at ~10 business days, LinkedIn outreach at ~3 weeks, stale at 5 weeks). Compute the actual dates.

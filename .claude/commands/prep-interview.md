---
description: Prepare for a specific interview round at a company
argument-hint: [company] [round type: screen|hiring-manager|case|behavioral|ways-of-working|final]
...
- Likely questions for this round type, each mapped to a story from prep.md
- Any [NEEDS YOUR STORY] gaps in prep.md that this round is likely to hit — flag them, don't fill them with invented material
- 2-3 questions to ask them, chosen from prep.md and tailored to what is actually unknown about this company
